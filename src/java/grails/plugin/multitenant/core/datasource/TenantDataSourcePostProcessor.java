...
// ========================================================================================================================
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        } else if (TransactionAwareDataSourceProxy.class.getName().equals(beanDefinition.getBeanClassName())) {
            // Added to support Grails 1.3.X
            beanDefinition.setBeanClassName(TenantTransactionAwareDataSourceProxy.class.getName());
        } else {
            return;
        }
